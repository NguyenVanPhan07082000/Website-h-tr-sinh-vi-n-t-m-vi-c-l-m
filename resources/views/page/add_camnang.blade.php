...
<div class="position-center">
    <form role="form" action="{{URL::to('/admin/save-camnang')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="txtTen" id="txtTen" placeholder="Nhập tên cẩm nang..." required>
        </div>
        <div class="form-group">
            <label for="exampleInputPassword1">Tiêu Đề</label>
            <input type="text" class="form-control" name="txtTieude" id="txtTieude" placeholder="Nhập tiêu đề cẩm nang..." required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea rows="4" class="form-control" name="txtGioithieu" id="txtGioithieu" placeholder="Giới thiệu về cẩm nang..." required></textarea>
        </div>
