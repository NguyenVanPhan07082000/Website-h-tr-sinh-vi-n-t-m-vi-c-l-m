...
<body>
    ...
    ?>
    <div class="menu">
        <a href="{{ URL::to('/trang-chu') }}"><img src="{{ asset('public/fontend/img/logo_top.png') }}"
                ...
                <li class="menu__main--content"><a href="{{ URL::to('/tat-ca-viec-lam') }}"
                    ...
                    <ul class="menu__main--content_ul">
                        ...
                        <li class="menu__main--content_li"><a href="{{ URL::to('/viec-lam-moi-nhat') }}"
                                class="menu__main--content_li--a">Việc Làm Mới Nhất</a></li>
                ...
                @if (session()->get('name'))
                    <li class="menu__main--content">
                        <p class="user" style="font-weight: bold">
                            ...
                            <img src="{{ asset('public/fontend/img/avatar/' . session()->get('img')) }}"
                                align="center" class="img_menu" alt="img"
                        ...
                        <ul class="menu__main--content_ul">
                            ...
                            <li class="menu__main--content_li"><a href="{{ URL::to('/doi-mat-khau') }}"
                                    class="menu__main--content_li--a">Đổi Mật Khẩu</a></li>
                        </ul>
                    </li>
                @else
                    <li class="menu__main--content"><a href="{{ URL::to('/login') }}"
                            class="menu__main--content__link">Đăng nhập</a></li>
                @endif
            </ul>
        </nav>
    </div>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function($) {
            $(window).load(function() {
                if ($('.menu').length > 0) {
                    var _top = $('.menu').offset().top - parseFloat($('.menu').css('marginTop').replace(
                        /auto/, 0));
        ...
        <div class="footer_info">
            <div class="row footer_info--top">
                ...
                <div class="col-1-of-4">
                    ...
                    <p class="footer_info--sv"><a href="https://careerbuilder.vn/" class="info-job_a">Career
                            Builder</a></p>
            ...
            <div class="footer_info--bottom">
                ...
                <p><a href="https://www.facebook.com/Nguyenvanphan0708/" class="info-job_a"><i
                            class="fa fa-facebook"> facebook</i></a></p>
            </div>
        </div>
        {!! Assets::renderFooter() !!}
    </footer>
