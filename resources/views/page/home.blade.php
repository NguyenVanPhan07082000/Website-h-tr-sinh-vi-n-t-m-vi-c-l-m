...
<header class="header">
    <div class="header__logo-box">
        <img src="{{asset('fontend/img/logo.png')}}" class="header__logo-box__logo" alt="logo"/>
    </div>
    ...
    <div class="header__profile">
        <a href="{{URL::to('/profile')}}" class="btn-name btn-profile"><img src="{{asset('fontend/img/avatar/phan.jpg')}}" class="header__profile__avatar" align="middle" alt="avatar" />Phần Nguyễn</a>
                ...
                @foreach ($jobnoibac as $key=>$jobnb)
                    <div class="job job--1">
                        <div class="col-1-of-4">
                            <img src="{{asset('fontend/img/company'.'/'.$jobnb->Hinhanh)}}" class="logo-company" alt="logo-company"/>
                        </div>
...
<div class="row">
    <div class="col-1-of-3 company_main company_main--1">
        <img src="{{asset('fontend/img/slogan_job.png')}}" class="company_main--slogan" alt="slogan"/>
    </div>
        ...
        @foreach ($company as $key =>$cp)
            <div class="col-1-of-3 card">
                <div class="card_side card_side--font">
                    <img src="{{asset('fontend/img/company'.'/'.$cp->Hinhanh)}}" class="company_main--logo_img" alt="logo_img"/>
                </div>
...
<div class="email">
    <img src="{{asset('fontend/img/job.jpg')}}" class="email_background" alt="email"/>
    ...
    <div class="review camnan_content">
        ...
        <div class="review-box">
          ...
          <div class="box">
            <div class="image">
                <img
                    src="{{asset('fontend/img/Camnan'.'/'.$cn->Hinhanh)}}"
                    alt="img"
                    />
            </div>
