            ...
            <div class="quanly_table">
                <table class="table_quanly">
                    ...
                    <tr class="table_rows table_row-content">
                        ...
                        <td class="td td_sk">
                            <a onclick="return confirm('Bạn có chắc muốn xoá?')" href="{{URL::to('/admin/delete-admin/'.$all_job->idAdmin)}}" class="btn-new">Xoá</a>
                            <a href="{{URL::to('/admin/edit-admin/'.$all_job->idAdmin)}}" class="btn-new">Sửa</a>
                        </td>
                    </tr>
                @endforeach
                </table>
