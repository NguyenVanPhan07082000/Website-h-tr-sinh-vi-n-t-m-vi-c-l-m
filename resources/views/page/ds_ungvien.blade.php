    ...
    <div class="page_job row">
        <div class="col-2-of-3">
            <div class="row title">
                ...
                <div class="col-1-of-2">
                    @foreach ($tongso as $key => $uv)
                        <h2 class="title_number">{{ $uv->tongso }} ứng viên</h2>
                    @endforeach
                </div>
            </div>
            <div class="main">
