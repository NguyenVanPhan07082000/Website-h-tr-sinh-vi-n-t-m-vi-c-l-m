    ...
    <ul class="sidebar-menu" id="nav-accordion">
        <li class="sub-menu">
            ...
            <ul class="sub">
                ...
                <li><a class="active" href="{{ URL::to('/admin/viec-lam-cho-duyet') }}">Việc Làm Chờ Duyệt</a></li>
                ...
                <table class="table_quanly">
                    ...
                    @foreach ($all_Job as $key => $all_job)
                        <tr class="table_rows table_row-content">
                            ...
                            <td class="td td_tvl"><a href="#" class="card_a-job">{{ $all_job->Nganhnghe }}</a>
                            </td>
                            <td class="td td_tgd">{{ $all_job->Ngaycapnhat }}</td>
                            <td class="td td_sk">
                                <a onclick="return confirm('Bạn có chắc muốn xoá?')"
                                    href="{{ URL::to('/admin/delete-job/' . $all_job->idJob) }}"
                                    class="btn-new">Xoá</a>
                                <a href="{{ URL::to('/admin/duyet-job/' . $all_job->idJob) }}"
                                    class="btn-new">Duyệt</a>
                            </td>
                        </tr>
                    @endforeach
                </table>
