...
Route::post('/dang-ky-email', [HomeController::class, 'dang_ky_email']);
...
Route::get('/admin/danh-sach-email-dang-ky', [AdminContrller::class, 'list_email']);
Route::get('/admin/send-email', [AdminContrller::class, 'send_email_all']);
//Việc làm
...
//CV-1
Route::get('/my-cv/{id}', [MyCV::class, 'MyCV']);
...
Route::get('/add-info-uv', [MyCV::class, 'add_info_uv']);
Route::post('/save-ung-vien', [MyCV::class, 'save_ung_vien']);
Route::post('/edit-ung-vien/{id}', [MyCV::class, 'edit_ung_vien']);
// Route::get('/tat-ca-viec-lam',[HomeController::class, 'all_job']);
// Route::get('/tim-ung-vien',[HomeController::class, 'timungvien']);
// Route::get('/dang-tuyen',[HomeController::class, 'dang_tuyen']);
// Route::post('/save-dang-tuyen',[HomeController::class, 'save_dang_tuyen']);