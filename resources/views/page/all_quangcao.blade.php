                    ...
                    @foreach ($all_Job as $key => $all_job)
                        <tr class="table_rows table_row-content">
                            ...
                            <td class="td td_ha"><img
                                    src="{{ asset('public/fontend/img/Quangcao') . '/' . $all_job->Hinhanh }}"
                            ...
                            <td class="td td_sk">
                                <a onclick="return confirm('Bạn có chắc muốn xoá?')"
                                    href="{{ URL::to('/admin/delete-quangcao/' . $all_job->idQuangcao) }}"
                                    class="btn-new">Xoá</a>
                                <a href="{{ URL::to('/admin/edit-quangcao/' . $all_job->idQuangcao) }}"
                                    class="btn-new">Sửa</a>
                            </td>
                        </tr>
                    @endforeach
