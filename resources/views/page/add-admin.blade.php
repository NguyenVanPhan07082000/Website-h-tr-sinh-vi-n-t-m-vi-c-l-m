    ...
    <div class="position-center">
        <form role="form" action="{{ URL::to('/admin/save-admin') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="txtTk" id="txtTk" placeholder="Nhập tên tài khoản..."
                    required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="txtTen" id="txtTen" placeholder="Nhập tên người dùng..."
                    required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="tel" class="form-control" pattern="[0-9]{10}" name="txtSDT" id="txtSDT"
